...
export async function uploadContracheque(token, formData) {
  try {
    const response = await fetch("http://localhost:4000/api/contracheques/upload", {
      method: "POST",
      headers: {
        Authorization: `Bearer ${token}`,
      },
...
export async function getMyContracheques(token) {
  try {
    const response = await fetch("http://localhost:4000/api/contracheques", {
      method: "GET",
      headers: {
        Authorization: `Bearer ${token}`,
      },
...
export async function getAllUsers(token) {
  try {
    const response = await fetch("http://localhost:4000/api/users/admin/all", {
      method: "GET",
      headers: {
        Authorization: `Bearer ${token}`,
      },
...
export async function activateUserByAdmin(token, userId) {
  try {
    const response = await fetch(
      `http://localhost:4000/api/users/${userId}/activate`,
      {
        method: "PATCH",
        headers: {
          Authorization: `Bearer ${token}`,
...
export async function getAllContrachequesForAdmin(token) {
  try {
    const response = await fetch("http://localhost:4000/api/contracheques/admin/all", {
      method: "GET",
      headers: {
        Authorization: `Bearer ${token}`,
      },
...
export async function removeContrachequeByAdmin(token, contrachequeId) {
  try {
    const response = await fetch(
      `http://localhost:4000/api/contracheques/${contrachequeId}`,
      {
        method: "DELETE",
        headers: {
          Authorization: `Bearer ${token}`,
